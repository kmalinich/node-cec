  ...
  this.NodeCec = (function(superClass) {
    ...
    NodeCec.prototype.processPacket = function(packet) {
      ...
      switch (packet.opcode) {
        case CEC.UserControlCode.ARROW_DOWN:
          this.emit('ARROW_DOWN', packet);
          return true;
        case CEC.UserControlCode.ARROW_LEFT:
          this.emit('ARROW_LEFT', packet);
          return true;
        case CEC.UserControlCode.ARROW_RIGHT:
          this.emit('ARROW_RIGHT', packet);
          return true;
        case CEC.UserControlCode.ARROW_UP:
          this.emit('ARROW_UP', packet);
          return true;
        case CEC.UserControlCode.ENTER:
          this.emit('ARROW_ENTER', packet);
          return true;
        case CEC.UserControlCode.EXIT:
          this.emit('EXIT', packet);
          return true;
